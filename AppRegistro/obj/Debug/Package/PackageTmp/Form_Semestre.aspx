<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PaginaMaestra.Master" CodeBehind="Form_Semestre.aspx.vb" Inherits="AppRegistro.Form_Semestre" %>
			...
			<div class="col-md-12 " >
					<section class="panel contenedor"  >
							<header class="panel-heading">
									<p style="text-align:center">Mantenimiento Semestre</p>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <table class="table_cajas" style="width: 100%;">
                                            ...
                                            <tr class ="filas">
                                                <td class="texto"><asp:Label ID="Label2" runat="server" Text=" Descripcion Semestre:"></asp:Label></td>
                                        ...
                                        <table style="width: 100%;" class="table_botones">
                                            <tr>
                                             ...
                                             <asp:GridView ID="gwSemestre"  class="table_grid" runat="server" AllowPaging="True" PageSize="5" Width="327px" DataKeyNames="ID">
                                                 <Columns>
