<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/PaginaMaestra.Master" CodeBehind="Form_Docente.aspx.vb" Inherits="AppRegistro.Form_Docente" %>
			...
			<div class="col-md-12 " >
					<section class="panel contenedor"  >
							<header class="panel-heading">
									<p style="text-align:center">Mantenimiento Docente</p>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <table class="table_cajas" style="width: 100%;">
                                            ...
                                            <tr class ="filas">
                                                ...
                                                <td><asp:TextBox ID="txtNombres" class="form-control caja_mediano" runat="server" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();"></asp:TextBox></td>
                                            </tr>
                                        </table>
                                        ...
                                        <table style="width: 100%;" class="table_botones">
                                            <tr>
                                             ...
                                             <asp:GridView ID="gwDocente"  class="table_grid" runat="server" AllowPaging="True" PageSize="5" Width="327px" DataKeyNames="ID">
                                                 <Columns>
